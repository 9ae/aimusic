...
class MarkovChainMelodyGenerator:
    ...
    def __init__(self, states):
        ...
        # dictionary to map states to their indexes in the states tuple list
    ...
    def _calculate_initial_probabilities(self, notes):
        """
        Calculate the initial probabilities from the provided notes and their duration
        simply as it stands alone in the piece.
    ...
    def _generate_starting_state(self):
        """
        Generate a starting note based on the initial probabilities.
...
def create_training_data():
    ...
    # ]
    return read_midi("data/furelise.mid")
